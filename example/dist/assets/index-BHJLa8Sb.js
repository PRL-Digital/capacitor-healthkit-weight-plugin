  ...
  if (h)
    return (
      ...
      I$1(c)
        ...
        : null != c &&
          (O$1(c) &&
            (c = N$1(c, e + (!c.key || (h && h.key === c.key) ? '' : ('' + c.key).replace(P$1, '$&/') + '/') + a)),
          b.push(c)),
      1
    );
  h = 0;
...
function Tc(a, b, c, d, e, f2) {
  if (null === a || a.nativeEvent !== f2)
    return (
      (a = { blockedOn: b, domEventName: c, eventSystemFlags: d, nativeEvent: f2, targetContainers: [e] }),
...
function ad(a, b) {
  a.blockedOn === b &&
    ((a.blockedOn = null), Jc || ((Jc = true), ca.unstable_scheduleCallback(ca.unstable_NormalPriority, $c)));
}
function bd(a) {
  function b(b2) {
    return ad(b2, a);
...
function rd(a) {
  ...
  A(b.prototype, {
    preventDefault: function () {
      ...
      a2 &&
        (a2.preventDefault ? a2.preventDefault() : 'unknown' !== typeof a2.returnValue && (a2.returnValue = false),
        (this.isDefaultPrevented = pd));
    },
    stopPropagation: function () {
      var a2 = this.nativeEvent;
      a2 &&
        (a2.stopPropagation ? a2.stopPropagation() : 'unknown' !== typeof a2.cancelBubble && (a2.cancelBubble = true),
...
var sd = {
  ...
  Ad = A({}, ud, {
    ...
    movementX: function (a) {
      ...
      a !== yd &&
        (yd && 'mousemove' === a.type ? ((wd = a.screenX - yd.screenX), (xd = a.screenY - yd.screenY)) : (xd = wd = 0),
        (yd = a));
      return wd;
    },
    ...
    if (null !== d && Ne(c)) {
      if (((b = d.start), (a = d.end), void 0 === a && (a = b), 'selectionStart' in c))
        ...
        e &&
          ...
          a.removeAllRanges(),
          f2 > d ? (a.addRange(b), a.extend(g.node, g.offset)) : (b.setEnd(g.node, g.offset), a.addRange(b)));
      }
    }
    b = [];
...
function Ue(a, b, c) {
  ...
  Te ||
    ...
    (Se && Ie(Se, d)) ||
      ...
      (d = oe(Re, 'onSelect')),
      0 < d.length &&
        ((b = new td('onSelect', 'select', null, b, c)), a.push({ event: b, listeners: d }), (b.target = Qe))));
}
function Ve(a, b) {
  var c = {};
      ...
      a: {
        ...
        if (k3 || h2) {
          ...
          if (k3 !== n2) {
            ...
            F2 = null;
            Wc(e2) === d2 &&
              ((t2 = new t2(x2, w2 + 'enter', n2, c, e2)), (t2.target = u2), (t2.relatedTarget = J2), (F2 = t2));
            J2 = F2;
            if (k3 && n2)
              b: {
                t2 = k3;
...
function Og(a) {
  ...
  function k2(a2, b2, c2, d2) {
    ...
    if (
      null !== b2 &&
      (b2.elementType === f3 || ('object' === typeof f3 && null !== f3 && f3.$$typeof === Ha && Ng(f3) === b2.type))
    )
  ...
  function q2(a2, b2, c2) {
    ...
    if ('object' === typeof b2 && null !== b2) {
      switch (b2.$$typeof) {
        case va:
          return (
            (c2 = Rg(b2.type, b2.key, b2.props, null, a2.mode, c2)), (c2.ref = Lg(a2, null, b2)), (c2.return = a2), c2
          );
        case wa:
  ...
  function n2(e2, g2, h2, k3) {
    ...
    if (null === u2) {
      for (; w2 < h2.length; w2++)
        (u2 = q2(e2, h2[w2], k3)),
          null !== u2 && ((g2 = f2(u2, g2, w2)), null === m3 ? (l3 = u2) : (m3.sibling = u2), (m3 = u2));
      I && tg(e2, w2);
      return l3;
    }
    ...
    if (null === m3) {
      for (; !n3.done; w2++, n3 = h2.next())
        (n3 = q2(e2, n3.value, k3)),
          null !== n3 && ((g2 = f2(n3, g2, w2)), null === u2 ? (l3 = n3) : (u2.sibling = n3), (u2 = n3));
      I && tg(e2, w2);
      return l3;
    }
            ...
            for (var k3 = f3.key, l3 = d2; null !== l3; ) {
              if (l3.key === k3) {
                ...
                if (k3 === ya) {
                  ...
                  l3.elementType === k3 ||
                  ('object' === typeof k3 && null !== k3 && k3.$$typeof === Ha && Ng(k3) === l3.type)
                ) {
                  c(a2, l3.sibling);
                  d2 = e(l3, f3.props);
                  d2.ref = Lg(a2, l3, f3);
...
function qh(a, b, c, d) {
  ...
  if (null !== h) {
    ...
    null !== m2 &&
      ((m2 = m2.updateQueue),
      (h = m2.lastBaseUpdate),
      h !== g && (null === h ? (m2.firstBaseUpdate = l2) : (h.next = l2), (m2.lastBaseUpdate = k2)));
  }
  if (null !== f2) {
    var q2 = e.baseState;
    g = 0;
    ...
    do {
      ...
      if ((d & r2) === r2) {
        ...
        (y2 = { eventTime: y2, lane: r2, tag: h.tag, payload: h.payload, callback: h.callback, next: null }),
  ...
  if (null !== e) {
    ...
    do {
      ...
      if ((Hh & m2) === m2)
        null !== k2 &&
          (k2 = k2.next =
            { lane: 0, action: l2.action, hasEagerState: l2.hasEagerState, eagerState: l2.eagerState, next: null }),
...
function Gi(a, b, c) {
  ...
  'object' === typeof f2 && null !== f2
    ? (f2 = eh(f2))
    : ((e = Zf(b) ? Xf : H.current), (d = b.contextTypes), (f2 = (d = null !== d && void 0 !== d) ? Yf(a, e) : Vf));
  b = new b(c, f2);
    ...
    return (
      a === b
        ...
        : ((a.flags |= 128),
          (c.flags |= 131072),
          (c.flags &= -52805),
          1 === c.tag && (null === c.alternate ? (c.tag = 17) : ((b = mh(-1, 1)), (b.tag = 2), nh(c, b, 1))),
          (c.lanes |= 1)),
      a
    );
  a.flags |= 65536;
...
function bj(a, b, c, d, e) {
  if (null !== a) {
    ...
    if (Ie(f2, d) && a.ref === b.ref)
      if (((dh = false), (b.pendingProps = d = f2), 0 !== (a.lanes & e))) 0 !== (a.flags & 131072) && (dh = true);
      ...
      ? ('function' === typeof y2 && (Di(b, c, y2, d), (n2 = b.memoizedState)),
        (l2 = jh || Fi(b, c, l2, d, r2, n2, k2) || false)
          ? (m2 ||
              ...
              'function' === typeof g.UNSAFE_componentWillUpdate && g.UNSAFE_componentWillUpdate(d, n2, k2)),
  ...
  if (null === a) {
    ...
    return f2
      ? ((d = b.mode),
        ...
        0 === (d & 1) && null !== f2 ? ((f2.childLanes = 0), (f2.pendingProps = g)) : (f2 = pj(g, d, 0, null)),
        (a = Tg(a, d, c, null)),
        (f2.return = b),
        (a.return = b),
        (f2.sibling = a),
      ...
      if (d.hasOwnProperty(l2) && k2 !== h && (null != k2 || null != h))
        if ('style' === l2)
          ...
          'dangerouslySetInnerHTML' === l2
            ...
            : 'children' === l2
              ? ('string' !== typeof k2 && 'number' !== typeof k2) || (f2 = f2 || []).push(l2, '' + k2)
              : 'suppressContentEditableWarning' !== l2 &&
                'suppressHydrationWarning' !== l2 &&
          ...
          for (var g in f2)
            if (f2.hasOwnProperty(g)) {
              ...
              'children' === g
                ? 'string' === typeof h
                  ? d.textContent !== h &&
                    (true !== f2.suppressHydrationWarning && Af(d.textContent, h, a), (e = ['children', h]))
                  : 'number' === typeof h &&
                    d.textContent !== '' + h &&
                    (true !== f2.suppressHydrationWarning && Af(d.textContent, h, a), (e = ['children', '' + h]))
          ...
          'http://www.w3.org/1999/xhtml' === a
            ? 'script' === c
              ...
              : 'string' === typeof d.is
                ...
                : ((a = g.createElement(c)),
                  'select' === c && ((g = a), d.multiple ? (g.multiple = true) : d.size && (g.size = d.size)))
                  ...
                  (f2 = c),
                    ...
                    null === g
                      ...
                      : ((f2.childLanes = g.childLanes),
                        ...
                        (f2.type = g.type),
                        (a = g.dependencies),
                        (f2.dependencies = null === a ? null : { lanes: a.lanes, firstContext: a.firstContext })),
                    (c = c.sibling);
                G(L, (L.current & 1) | 2);
                return b.child;
              }
              ...
              case 1:
                if (null !== n2) {
                  var t2 = n2.memoizedProps,
                    J2 = n2.memoizedState,
                    x2 = b.stateNode,
                    w2 = x2.getSnapshotBeforeUpdate(b.elementType === b.type ? t2 : Ci(b.type, t2), J2);
...
function Sj(a) {
  ...
  a.sibling = null;
  5 === a.tag &&
    ((b = a.stateNode), null !== b && (delete b[Of], delete b[Pf], delete b[of], delete b[Qf], delete b[Rf]));
  a.stateNode = null;
  a.return = null;
  a.dependencies = null;
...
function Zj(a, b, c) {
  ...
  switch (c.tag) {
    ...
    case 6:
      ...
      null !== X &&
        (Xj
          ? ((a = X), (c = c.stateNode), 8 === a.nodeType ? a.parentNode.removeChild(c) : a.removeChild(c))
          : X.removeChild(c.stateNode));
      break;
    case 18:
      null !== X &&
        (Xj
          ? ((a = X), (c = c.stateNode), 8 === a.nodeType ? Kf(a.parentNode, c) : 1 === a.nodeType && Kf(a, c), bd(a))
          : Kf(X, c.stateNode));
      break;
    case 4:
      d = X;
                ...
                (e = q2.stateNode),
                  l2
                    ...
                    : ((h = q2.stateNode),
                      ...
                      (g = void 0 !== k2 && null !== k2 && k2.hasOwnProperty('display') ? k2.display : null),
      ...
      if (!g) {
        ...
        if ((U = k2) && !l2)
          for (V = e; null !== V; )
            (g = V),
              (k2 = g.child),
              22 === g.tag && null !== g.memoizedState ? jk(e) : null !== k2 ? ((k2.return = g), (V = k2)) : jk(e);
  ...
  if (0 !== b) {
    ...
    if (6 === b) Ck(a, d);
      ...
      if (
        0 === (d & 30) &&
        !Ok(e) &&
        ((b = Ik(a, d)), 2 === b && ((f2 = xc(a)), 0 !== f2 && ((d = f2), (b = Nk(a, f2)))), 1 === b)
      )
      ...
      a: {
        ...
        if (null !== k2 && 'object' === typeof k2 && 'function' === typeof k2.then) {
          ...
          if (0 === (m2.mode & 1) && (0 === q2 || 11 === q2 || 15 === q2)) {
            var r2 = m2.alternate;
            r2
              ? ((m2.updateQueue = r2.updateQueue), (m2.memoizedState = r2.memoizedState), (m2.lanes = r2.lanes))
            ...
            case 1:
              ...
              if (
                ...
                ('function' === typeof w2.getDerivedStateFromError ||
                  (null !== u2 && 'function' === typeof u2.componentDidCatch && (null === Ri || !Ri.has(u2))))
              ) {
                f2.flags |= 65536;
                b &= -b;
                f2.lanes |= b;
...
const __vitePreload = function preload(baseModule, deps, importerUrl) {
  ...
  if (deps && deps.length > 0) {
    ...
    const cspNonce =
      (cspNonceMeta == null ? void 0 : cspNonceMeta.nonce) ||
      (cspNonceMeta == null ? void 0 : cspNonceMeta.getAttribute('nonce'));
    promise = Promise.all(
      deps.map((dep) => {
        dep = assetsURL(dep);
...
const CapacitorPlatforms = /* @__PURE__ */ initPlatforms(
...
const createCapacitor = (win) => {
  ...
  const getPlatform =
    ((_a = capPlatforms === null || capPlatforms === void 0 ? void 0 : capPlatforms.currentPlatform) === null ||
    _a === void 0
      ? void 0
      : _a.getPlatform) || defaultGetPlatform;
  const defaultIsNativePlatform = () => getPlatform() !== 'web';
  const isNativePlatform =
    ((_b = capPlatforms === null || capPlatforms === void 0 ? void 0 : capPlatforms.currentPlatform) === null ||
    _b === void 0
      ? void 0
  ...
  const isPluginAvailable =
    ((_c = capPlatforms === null || capPlatforms === void 0 ? void 0 : capPlatforms.currentPlatform) === null ||
    _c === void 0
      ? void 0
  ...
  const getPluginHeader =
    ((_d = capPlatforms === null || capPlatforms === void 0 ? void 0 : capPlatforms.currentPlatform) === null ||
    _d === void 0
      ? void 0
      ...
      if (pluginHeader) {
        const methodHeader =
          pluginHeader === null || pluginHeader === void 0
            ? void 0
            : pluginHeader.methods.find((m2) => prop === m2.name);
        if (methodHeader) {
  ...
  const registerPlugin2 =
    ((_e = capPlatforms === null || capPlatforms === void 0 ? void 0 : capPlatforms.currentPlatform) === null ||
    _e === void 0
      ? void 0
...
const CapacitorHealthkit = registerPlugin('CapacitorHealthkit', {
  web: () =>
    __vitePreload(() => import('./web-kjSgWs2r.js'), true ? [] : void 0).then((m2) => new m2.CapacitorHealthkitWeb()),
});
const styles = {
  form: {
    display: 'flex',
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
        children: 'This app shows your recent weight entries from Healthkit and allows you to add new entries.',
      }),
      authorizationStatus !== 'sharingAuthorized' &&
        /* @__PURE__ */ jsxRuntimeExports.jsx('button', {
          onClick: requestAuthorization,
          children: 'Request Healthkit Authorization',
        }),
      authorizationStatus === 'sharingAuthorized' &&
        /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
          children: [
            ...
            weightEntries.length === 0
              ? /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                  children: 'No weight entries found for the last 30 days.',
                })
              : /* @__PURE__ */ jsxRuntimeExports.jsx('ul', {
                  children: weightEntries.map((entry) =>
